...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $program1->setPoster("twd.jpg");
        $program1->setOwner($this->getReference('user@wildseries.com'));
        ...
        $program2->setPoster("dw.jpg");
        $program2->setOwner($this->getReference('user@wildseries.com'));
        ...
        $program3->setPoster("bb.jpg");
        $program3->setOwner($this->getReference('user@wildseries.com'));
        ...
        $program4->setPoster("thod.jpg");
        $program4->setOwner($this->getReference('admin@wildseries.com'));
        ...
        $program5->setPoster("ahs.jpg");
        $program5->setOwner($this->getReference('admin@wildseries.com'));
